  ...
  return (
    <Page>
      <div className="mx-auto mt-16 max-w-[420px] rounded-[14px] border border-dashed border-line-strong p-10 text-center">
        ...
        <div className="mb-5 text-[13px] leading-[1.55] text-mute-2">It was deleted, or it belongs to a client you cannot see. Ask an admin if you think you should.</div>
        <Link href="/" className="text-[12.5px] font-semibold text-accent hover:underline">Back to the Street</Link>
      </div>
    </Page>
  );
}
