...
export function Library() {
  ...
  return (
    <Page>
      ...
      <p className="mb-6 max-w-[64ch] text-[14px] text-[#71807A] text-pretty">
      ...
      <div className="mb-3.5 flex items-center gap-2.5">
        <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search the workshop" aria-label="Search the workshop" className="field max-w-[280px] flex-1 text-[12.5px]" />
      </div>
