...
export function OfflineBar() {
  ...
  return (
    <div role="status" className="fixed inset-x-0 top-0 z-[130] flex items-center justify-center gap-3 bg-ink px-4 py-2 text-[13px] text-white" style={{ paddingTop: "max(8px, env(safe-area-inset-top))" }}>
