  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-wash px-6">
      <div className="max-w-[380px] text-center">
        ...
        <p className="mb-6 mt-0 text-[15px] leading-[1.55] text-mute-1">BrandOS needs a connection to show your clients and assets. Nothing you saved is lost — it is all on the server.</p>
        <RetryButton />
      </div>
    </main>
  );
