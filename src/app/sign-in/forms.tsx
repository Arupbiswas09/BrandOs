    ...
    <div className="overflow-hidden rounded-[14px] border border-[#E2E8F0] bg-white">
      {people.map((p) => (
        <button
          ...
          className="flex w-full items-center gap-3 border-t border-[#F1F5F9] px-5 py-3.5 text-left first:border-t-0 hover:bg-[#F8FAFC] disabled:opacity-60"
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className="block text-[14.5px] text-[#4B5A6E]">{p.role}</span>
          </span>
